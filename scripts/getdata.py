...
def change_link_state(t, quat):
    ...
    try:
        state = LinkState()
        state.link_name = 'Apriltag36::main'
...
if __name__ == '__main__':
    ...
    rospy.init_node('ocam_calibration')
    ...
    pkg_path = rospack.get_path('obj_with_6dof')
    ...
    # cam1, cam2
    sub1 = rospy.Subscriber('/front_cam_fisheye/image_raw', Image, (lambda img : image_callback(cam1_queue, img)), queue_size=10)
            ...
            if key in t_step_key_map:
                ...
                if bag is None:
                    if not cam1_queue.empty():
                        ...
                        img_name = '{}/{}.jpg'.format(save_dir, img_counter)
